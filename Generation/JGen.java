...
public class JGen {
    private static int SF = 10050;

    private static FileWriter writer;
    private static Random random = new Random();

    private final static String folderStructure = "Data\\";
    ...
    public static void main (final String[] args) {
        ...
        if (args.length > 0) {
            try {
                SF = Integer.parseInt(args[0]);
            } catch (NumberFormatException e) {
                System.err.println("SF must be an integer.");
            }
        } else {
            System.err.println("SF should be provided as a command line argument.");
        }
        ...
        try {
            ...
            //write this info
            writer = new FileWriter(folderStructure + "Department" + fileExtention);
        ...
        try {
            writer = new FileWriter(folderStructure + "Classroom" + fileExtention);
        ...
        try {
            writer = new FileWriter(folderStructure + "Time_Slot" + fileExtention);
        ...
        try {
            writer = new FileWriter(folderStructure + "Student" + fileExtention);
        ...
        try {
            writer = new FileWriter(folderStructure + "Instructor" + fileExtention);
        ...
        try {
            writer = new FileWriter(folderStructure + "Advisor" + fileExtention);
        ...
        try {
            writer = new FileWriter(folderStructure + "Course" + fileExtention);
        ...
        try {
            writer = new FileWriter(folderStructure + "Prereq" + fileExtention);
        ...
        String[] courseToYear = new String[numCourses];
        String[] courseToSemester = new String[numCourses];
        int[] courseToNumSections = new int[numCourses];
        try {
            writer = new FileWriter(folderStructure + "Section" + fileExtention);
        ...
        try {
            writer = new FileWriter(folderStructure + "Teaches" + fileExtention);
        ...
        try {
            ...
            writer = new FileWriter(folderStructure + "Takes" + fileExtention);
