...
public class JGen {
   ...
   //given index (building - 1), value is number of rooms in that building
	...
	private static void generateFileWriter(final String fileName) {
		try { writer = new FileWriter(folderStructure + fileName + fileExtention); }
		catch(Exception e) {}
	}
